...
public class MenuController implements Serializable {
    ...
    @EJB private com.orprovisa.ejb.MenuFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    private List<Menu> lista;
    private MenuModel model; //Definir modelo 
    ...
    public void establecerPermisos(){
        ...
        for(Menu m : lista ){
            if(m.getTipo().equals("s")){//En cuyo caso sea un submenu
               DefaultSubMenu firstSubmenu = new DefaultSubMenu(m.getNombre());
               for(Menu i : lista){
                   Menu submenu = i.getCodigoSubmenu();//Referencia en la concurrencia 
                   if(submenu != null){//Algoritmo parra evitar un nullpointerEsxeption

...
import com.orprovisa.ejb.EtapaFacade;
...
public class EtapaController implements Serializable {
    ...
    @EJB
    private com.orprovisa.ejb.EtapaFacade ejbFacade;
    ...
    public Etapa getEtapa(java.lang.Integer id) {
    ...
    public static class EtapaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEtapa(getKey(value));
        }

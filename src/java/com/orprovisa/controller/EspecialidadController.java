...
public class EspecialidadController implements Serializable {
    ...
    @EJB
    private com.orprovisa.ejb.EspecialidadFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Especialidad) getItems().getRowData();
